...
public class PermotionMgrFactory {
private JAXBContext jaxbContext;
private PermotionMgr mgr;
	
	private static String packageName = "com.xl.cm.core.entity";
	private String xmlFileName = "PermotionFeed.xml";	
	private PermotionMgrFactory(){
	...
	private void createEntitylist() {
		...
		mgr = (PermotionMgr) unmarshaller.unmarshal(new File(xmlFileName));
		} catch (JAXBException e) {
	...
	public PermotionMgr getMgr() {
		return mgr;
	}

	public void setMgr(PermotionMgr mgr) {
		this.mgr = mgr;
	}
	
	static class EntityFeedUtilHolder{
		private static final PermotionMgrFactory _instance=new PermotionMgrFactory();
	}
	
	public static PermotionMgrFactory getInstance(){
