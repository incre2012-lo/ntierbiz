...
public class XLSX2CSV {
	...
	public PrintStream getStream(String sheet) throws FileNotFoundException {
    	SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy_MM_dd-HH-mm-ss");
        String dateToday= dateFormat.format(new Date());
        String loadedFile=dateToday+sheet+".csv";
        File csvfile=new File(tempFolder,loadedFile);
        return new PrintStream(csvfile);
	}
    ...
    public void process()
        ...
        while (iter.hasNext()) {
            ...
            this.output=getStream(sheetName);
