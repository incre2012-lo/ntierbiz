		...
		if (p.usepager) {
			...
			if (p.searchitems) {
				...
				$(g.sDiv).append("<div class='sDiv2'>" + p.findtext +
						...
						" <select name='qtype'>" + sopt + "</select><input id='SearchBtn' type='button' class='clearbtn' value='Search' /><input type='button' class='clearbtn' value='Clear' /></div>");
