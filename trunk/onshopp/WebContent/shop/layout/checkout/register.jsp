...
<div class="box tp_mg10">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="s">
		<tr>
			<td class="table_detail e s center">&nbsp;<input type="button" name="next" value="Register">
			</td>
			<td class="table_detail e s center">&nbsp;<input type="button" name="next" value="Sign Up">
			</td>
			<td class="table_detail e s center">&nbsp;<input type="button" name="next" value="Subscribe">
			</td>
			<td class="table_detail e s center">&nbsp;<a href="#" rel=close><input type="button" name="next" value="Checkout Now" ></a>
			</td>
			<td class="table_detail e s center">&nbsp;<a href="#" rel=close><input type="button" name="continue" value="Continue Shopping"></a>
			</td>
...
<div class="section box">
		<h2 class="redbg" >Please enter following details for fast checkout</h2>
...
<div class="box tp_mg10">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="s">
		<tr>
			<td class="table_detail e s center">&nbsp;Skip and click on next button for checkout as a guest.
			</td>
			<td class="table_detail e s center">&nbsp;<a href="<c:url value="/checkout/step1.a_ajax/step1.b/show_alias" />" rel="internal" ><input type="button" name="next" value="Guest Checkout"></a>
			</td>
		</tr>
	</table>
</div>